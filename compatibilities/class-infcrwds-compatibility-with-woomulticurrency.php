...
class INFCWDS_Compatibility_With_WooMultiCurrency {
...
INFCWDS_Plugin_Compatibilities::register( new INFCWDS_Compatibility_With_WooMultiCurrency(), 'woomulticurrency' );
