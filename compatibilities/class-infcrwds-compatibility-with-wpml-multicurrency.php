...
class INFCWDS_Compatibility_With_WPML_MultiCurrency {
...
INFCWDS_Plugin_Compatibilities::register( new INFCWDS_Compatibility_With_WPML_MultiCurrency(), 'woowpmlmulticurrency' );
